...
{
private:
	double xAngle; //angle that camera rotate about x axis
	double yAngle;
	double zAngle;
	double x;
	double y;
	double z;
public:
	Camera() : xAngle(0), yAngle(0), zAngle(0), x(getScreneToCentreDistance()), y(0), z(0) {}
	double getXAngle() { return xAngle; }
	double getYAngle() { return yAngle; }
	double getZAngle() { return zAngle; }
